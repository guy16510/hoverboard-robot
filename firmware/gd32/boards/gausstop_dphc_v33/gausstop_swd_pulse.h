...
enum {
  ...
  GS_SWD_PULSE_NOMINAL_UNIT_US = 64u,
  GS_SWD_PULSE_MIN_UNIT_US = 48u,
  GS_SWD_PULSE_MAX_UNIT_US = 96u,
  GS_SWD_PULSE_SYNC_UNITS = 10u,
  GS_SWD_PULSE_SYMBOL_TOLERANCE_NUMERATOR = 7u,
  GS_SWD_PULSE_SYMBOL_TOLERANCE_DENOMINATOR = 16u,
  GS_SWD_PULSE_SYNC_US = GS_SWD_PULSE_NOMINAL_UNIT_US * GS_SWD_PULSE_SYNC_UNITS,
  GS_SWD_PULSE_SEPARATOR_US = 64u,
  GS_SWD_PULSE_SYNC_SEPARATOR_US = 128u,
  GS_SWD_PULSE_FRAME_GAP_TIMEOUT_US = 2000u,
};
